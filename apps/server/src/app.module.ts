...
import { IEnvironments } from './modules/config/environment.interface';
import { databaseEnvironment } from './modules/config/services/database.config';
import { redisEnvironment } from './modules/config/services/redis.config';
import { serverEnvironment } from './modules/config/services/server.config';
